...
bios_mmap:
	...
	; print header
	push mmap_header_msg
	call bios_println
	push mmap_fields_msg
	call bios_println
...
mmap_error_msg db "Error getting memory map", 0
mmap_success_msg db "Memmory map read successfully!", 0
mmap_new_region_msg db "New region: ", 0
mmap_header_msg db "Reading memory map:", 0
